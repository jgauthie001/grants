...
public static class GrantsFighter
{
    ...
    public static readonly UniqueCard U_BullRush = new()
    {
        ...
        Name = "Bull Rush_pl",
        Description = "A relentless charge that drives the opponent back — land it and keep pressing._pl",
        RequiredBodyTags = new() { "lower", "core" },
        Keywords = new() { new CardKeywordValue(CardKeyword.Lunge), new CardKeywordValue(CardKeyword.Knockback), new CardKeywordValue(CardKeyword.FollowThrough, 1) },
        BasePower = 3,
        BaseDefense = 0,
        BaseSpeed = 0,
        MinMovement = 1,
    ...
    public static readonly UniqueCard U_LowSweep = new()
    {
        ...
        Name = "Low Sweep_pl",
        Description = "A fast sweeping kick at the legs — if you miss your range, you've already committed to getting out._pl",
        RequiredBodyTags = new() { "leg" },
        Keywords = new() { new CardKeywordValue(CardKeyword.Disengage, 1) },
        BasePower = 2,
        BaseDefense = 1,
        BaseSpeed = 2,
        MinMovement = 0,
    ...
    public static readonly UniqueCard U_Overhand = new()
    {
        ...
        Name = "Overhand_pl",
        Description = "A heavy looping blow — the weight commits you, landing or not, you snap back after._pl",
        RequiredBodyTags = new() { "arm", "upper" },
        Keywords = new() { new CardKeywordValue(CardKeyword.ArmorBreak), new CardKeywordValue(CardKeyword.Recoil, 1) },
        BasePower = 3,
        BaseDefense = 0,
        BaseSpeed = -1,
        MinMovement = 0,
    ...
    public static readonly UniqueCard U_BodyShot = new()
    {
        ...
        Keywords = new() { new CardKeywordValue(CardKeyword.Bleed) },
        BasePower = 2,
        BaseDefense = 1,
        BaseSpeed = 0,
        MinMovement = 0,
    ...
    public static readonly SpecialCard S_Obliterator = new()
    {
        ...
        Keywords = new() { new CardKeywordValue(CardKeyword.Crushing), new CardKeywordValue(CardKeyword.ArmorBreak) },
        BasePower = 7,
        BaseDefense = 0,
        BaseSpeed = -2,
        MaxMovement = 0,
    ...
    public static readonly SpecialCard S_BerserkRush = new()
    {
        ...
        Keywords = new() { new CardKeywordValue(CardKeyword.Lunge), new CardKeywordValue(CardKeyword.Bleed) },
        BasePower = 5,
        BaseDefense = -1,
        BaseSpeed = 1,
        MinMovement = 2,
    ...
    public static FighterDefinition CreateDefinition() => new()
    {
        ...
        GenericCards = new() { G_Head.Clone(), G_Torso.Clone(), G_LeftArm.Clone(), G_RightArm.Clone(), G_LeftLeg.Clone(), G_RightLeg.Clone(), G_Core.Clone(), G_Stance.Clone() },
        UniqueCards = new() { U_Haymaker.Clone(), U_Clinch.Clone(), U_CrossCounter.Clone(), U_BullRush.Clone(), U_LowSweep.Clone(), U_Overhand.Clone(), U_SideStep.Clone(), U_BodyShot.Clone() },
        SpecialCards = new() { S_Obliterator.Clone(), S_BerserkRush.Clone(), S_KillTest.Clone() },
