...
public static class GrantsFighter
{
    ...
    public static readonly UniqueCard U_BullRush = new()
    {
        ...
        Keywords = new() { new CardKeywordValue(CardKeyword.Lunge), new CardKeywordValue(CardKeyword.Knockback) },
        BasePower = 3,
        BaseDefense = 0,
        BaseSpeed = 0,
        MinMovement = 1,
    ...
    public static readonly UniqueCard U_Overhand = new()
    {
        ...
        RequiredBodyTags = new() { "arm", "upper" },
        Keywords = new() { new CardKeywordValue(CardKeyword.ArmorBreak) },
        BasePower = 3,
        BaseDefense = 0,
        BaseSpeed = -1,
        MaxMovement = 0,
